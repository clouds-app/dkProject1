<template>
  ...
  <header class="bg-black lter header header-md navbar navbar-fixed-top-xs">
    <div class="navbar-header aside bg-success nav-xs">
      ...
      <a href="index.html"  class="navbar-brand text-lt"> <i class="icon-earphones"></i>
        <img src="../../../static/images/logo.png" alt="." class="hide" /> <span class="hidden-nav-xs m-l-sm">Musik</span> </a>
      ...
      <ul class="nav navbar-nav m-n hidden-xs nav-user user">
        <li class="hidden-xs"> <a href="#" class="dropdown-toggle lt" data-toggle="dropdown"> <i class="icon-bell"></i> <span class="badge badge-sm up bg-danger count">2</span> </a>
          <section class="dropdown-menu aside-xl animated fadeInUp">
            ...
            <img src="../../../static/images/a0.png"  alt="..." class="img-circle" /> </span> <span class="media-body block m-b-none"> Use awesome animate.css<br /> <small class="text-muted">10 minutes ago</small> </span> </a>
        ...
        <!--登录信息-->
        <li class="dropdown"> <a href="#" class="dropdown-toggle bg clear" data-toggle="dropdown"> <span class="thumb-sm avatar pull-right m-t-n-sm m-b-n-sm m-l-sm"> <img src="../../../static/images/a0.png"  alt="..." /> </span> {{this.ShopTitle}} - {{CurrentTerminalId}} <b class="caret"></b> </a>
          <ul class="dropdown-menu animated fadeInRight">
            <!--<li> <span class="arrow top"></span> <a href="#">Settings</a> </li>-->
            <!--<li> <a href="profile.html" >店铺信息</a> </li>-->
            <!--<li> <a href="#"> <span class="badge bg-danger pull-right">3</span> Notifications </a> </li>-->
            <!--<li> <a href="docs.html" >Help</a> </li>-->
            <!--<li class="divider"></li>-->
            <li>  <a href="#modal-form" data-toggle="modal">注册/登录</a>  </li>
...
<script>
  ...
  export default {
    ...
    watch:{
      AccountInfo()
      {
        this.ShopTitle = this.AccountInfo.shopName;
      }
